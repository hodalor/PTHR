...
export const moduleUiData = {
  'employee-management': {
    ...
    formFields: [
      ...
      // accessAccount removed from form
      ...
      { key: 'assignedShift', label: 'Assigned Shift', type: 'select' },
      ...
      { key: 'emergencyContact1Name', label: 'Emergency Contact 1 Name' },
      { key: 'emergencyContact1Phone', label: 'Emergency Contact 1 Phone', type: 'tel' },
      { key: 'emergencyContact2Name', label: 'Emergency Contact 2 Name' },
      { key: 'emergencyContact2Phone', label: 'Emergency Contact 2 Phone', type: 'tel' },
      { key: 'referee1', label: 'Referee 1' },
      { key: 'referee1Phone', label: 'Referee 1 Phone', type: 'tel' },
      { key: 'referee1Email', label: 'Referee 1 Email', type: 'email' },
      { key: 'referee2', label: 'Referee 2' },
      { key: 'referee2Phone', label: 'Referee 2 Phone', type: 'tel' },
      { key: 'referee2Email', label: 'Referee 2 Email', type: 'email' },
      {
        key: 'status',
        label: 'Status',
        type: 'select',
  ...
  'loan-records': {
    ...
    formFields: [
      ...
      { key: 'overduePenaltyPercentPerDay', label: 'Overdue Penalty % / Day', type: 'number' },
